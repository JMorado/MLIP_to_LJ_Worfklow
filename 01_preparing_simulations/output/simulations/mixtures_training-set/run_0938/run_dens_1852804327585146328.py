...
smiles1 = "[H:10][C:4]([H:11])([H:12])[C:3]([C:5]([H:13])([H:14])[H:15])([C:6]([H:16])([H:17])[H:18])[O:2][C:1]([H:7])([H:8])[H:9]"
smiles2 = "[H:5][C:2]([Cl:1])([Cl:3])[Cl:4]"
x1 = 0.4539999999999999
x2 = 0.546
density = 1.0838000000000003
