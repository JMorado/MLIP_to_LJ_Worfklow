...
smiles1 = "[H:7][C:1]([H:8])([H:9])[N:2]([C:3]([H:10])([H:11])[H:12])[C:4]([H:13])([H:14])[C:5]([H:15])([H:16])[O:6][H:17]"
smiles2 = "[H:2][O:1][H:3]"
x1 = 0.2643298443255894
x2 = 0.7356701556744105
density = 0.9590000000000002
