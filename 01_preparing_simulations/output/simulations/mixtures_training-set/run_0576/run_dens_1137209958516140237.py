...
smiles1 = "[H:6][C:1]([H:7])([H:8])[C:2]([H:9])([H:10])[C:3]([H:11])([H:12])[C:4]([H:13])([H:14])[O:5][H:15]"
smiles2 = "[H:12][C:6]1([C:2](=[N:3][C:4]([C:5]1([H:10])[H:11])([H:8])[H:9])[O:1][H:7])[H:13]"
x1 = 0.7555000000000001
x2 = 0.2445
density = 0.8711500000000002
