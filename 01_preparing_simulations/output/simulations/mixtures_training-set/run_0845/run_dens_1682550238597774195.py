...
smiles1 = "[H:2][O:1][H:3]"
smiles2 = "[H:15][C:5]1([C:6]([O:7][C:8]([C:9]([N:4]1[C:3]([H:13])([H:14])[C:2]([H:11])([H:12])[O:1][H:10])([H:21])[H:22])([H:19])[H:20])([H:17])[H:18])[H:16]"
x1 = 0.5147999999999999
x2 = 0.4852
density = 1.0866900000000004
