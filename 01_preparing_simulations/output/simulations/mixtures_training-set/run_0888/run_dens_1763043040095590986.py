...
smiles1 = "[H:6][C:1]([H:7])([H:8])[C:2]([H:9])([H:10])[C:3]([H:11])([H:12])[C:4]([H:13])([H:14])[C:5]([H:15])([H:16])[H:17]"
smiles2 = "[H:17][C:6](=[O:7])[O:5][C:4]([H:15])([H:16])[C:3]([H:13])([H:14])[C:2]([H:11])([H:12])[C:1]([H:8])([H:9])[H:10]"
x1 = 0.6990000000000001
x2 = 0.301
density = 0.6994600000000002
