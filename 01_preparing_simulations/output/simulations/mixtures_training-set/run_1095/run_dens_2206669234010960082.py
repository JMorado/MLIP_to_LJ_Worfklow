...
smiles1 = "[H:12][C:1]([H:13])([H:14])[C:2]([H:15])([H:16])[O:3][C:4](=[O:5])[C:6]([H:17])([H:18])[C:7](=[O:8])[O:9][C:10]([H:19])([H:20])[C:11]([H:21])([H:22])[H:23]"
smiles2 = "[H:3][C:1]([H:4])([H:5])[O:2][H:6]"
x1 = 0.5004
x2 = 0.4996
density = 0.9962350000000002
